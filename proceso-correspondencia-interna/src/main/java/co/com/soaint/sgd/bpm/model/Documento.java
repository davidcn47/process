...
public class Documento implements Serializable {
    ...
    public String getNroRadicado() { return nroRadicado; }

    public void setNroRadicado(String nroRadicado) { this.nroRadicado = nroRadicado; }

    public String getIdeEcm() { return ideEcm; }

    public void setIdeEcm(String ideEcm) { this.ideEcm = ideEcm; }
